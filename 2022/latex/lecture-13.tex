...
\begin{center}
\begin{tikzpicture}[every node/.style={minimum height=0.8em,fill=green,inner sep=0,outer sep=0,draw},every label/.style={blue,fill=none,draw=none,font=\small}]
%%%% 左
%% A
\node[minimum width=4em,fill=none] (a) { };
\node[anchor=south,minimum width=3em,fill=none] (b) at(a.north) { };
\node[anchor=south,minimum width=2em,fill=none] (c) at(b.north) { };
\node[anchor=south,minimum width=1em,fill=none,label={left:$n$}] (d) at(c.north) { };
\draw[] (a.south) -- +(0,3.5em);
\node[fill=none,draw=none] (aa) at($(a.south)+(0,-0.3cm)$) {A};

\begin{scope}[xshift=2cm]
%% B
\node[minimum width=4em,fill=none,draw=none] (a) { };
\draw[] (a.south) -- +(0,3.5em);
\draw[] (a.south west) -- (a.south east);
\node[fill=none,draw=none] (bb) at($(a.south)+(0,-0.3cm)$) {B};

%% C 
\begin{scope}[xshift=2cm]
\node[minimum width=4em] (a) { };
\node[anchor=south,minimum width=3em] (b) at(a.north) { };
\node[anchor=south,minimum width=2em] (c) at(b.north) { };
\node[anchor=south,minimum width=1em,label={right:$n$}] (d) at(c.north) { };
\draw[] (a.south) -- +(0,3.5em);
\node[fill=none,draw=none] (cc) at($(a.south)+(0,-0.3cm)$) {C};
\end{scope}
\end{scope}

\path[->,dashed]
($(aa)+(0,1cm)$) edge[bend left] node[fill=none,draw=none,anchor=south,pos=0.7]{$n$} ($(cc)+(0,1cm)$);

\node[text width=.9\textwidth,anchor=north,rounded corners,fill=none,inner sep=5pt] at($(bb)+(0,-0.7cm)$) {
...
\node[text width=.45\textwidth,anchor=north,rounded corners,fill=none,inner sep=5pt] (t) at($(bb)+(0,-0.5cm)$) {
由A至C, 移动$n$个盘子, 借助$B$. 递归实现如下:
\vspace*{-0.2cm}
\begin{enumerate}[1]
\item 由A至B, 移动(n-1)个盘子, 借助C; 

\item 由A至C, 移动1个盘子; 

\item 由B至C, 移动(n-1)个盘子, 借助A.
\end{enumerate}
};

\node[anchor=north,fill=green,rounded corners, outer sep=5pt,inner sep=5pt,draw=none] at(t.south){
	借助空塔, 实现另外两塔间的盘子移动。
};
...
\node[anchor=south,minimum width=3em] (b) at(a.north) { };
\node[anchor=south,minimum width=2em] (c) at(b.north) { };
\node[anchor=south,minimum width=1em] (d) at(c.north) { };
\draw[] (a.south) -- +(0,3.5em);
\node[fill=none,draw=none] (aa) at($(a.south)+(0,-0.3cm)$) {A};

%% 中间线
\draw[dashed,red] ($(a.south west)+(-1.5em,3.5em)$) -- +(0,-20em);

\begin{scope}[xshift=2cm]
%% B
\node[minimum width=3em] (a) { };
\node[anchor=south,minimum width=2em] (b) at(a.north) { };
\node[anchor=south,minimum width=1em,label={right:$n-1$}] (c) at(b.north) { };
\draw[] (a.south) -- +(0,3.5em);
\node[fill=none,draw=none] (bb) at($(a.south)+(0,-0.3cm)$) {B};
...
\path[->,dashed]
($(aa)+(0,1cm)$) edge[bend left] node[fill=none,draw=none,anchor=south]{(1) $n-1$} ($(bb)+(0,1cm)$);
...
\path[->,dashed]
($(aa)+(0,1cm)$) edge[bend left] node[fill=none,draw=none,anchor=south]{(2) $1$} ($(cc)+(0,1cm)$);
...
\begin{scope}[xshift=2cm]
%% B
\node[minimum width=3em,fill=none] (a) { };
\node[anchor=south,minimum width=2em,fill=none] (b) at(a.north) { };
\node[anchor=south,minimum width=1em,fill=none,label={left:$n-1$}] (c) at(b.north) { };
...
\path[->,dashed]
($(bb)+(0,1cm)$) edge[bend left] node[fill=none,draw=none,anchor=south]{(3) $n-1$} ($(cc)+(0,1cm)$);
\end{scope}
\end{scope}
\end{scope}
\end{tikzpicture}
