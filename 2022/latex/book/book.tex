...
\usetikzlibrary{shapes.arrows,arrows,automata,matrix,arrows,graphs,shadows,calc,decorations.pathmorphing,backgrounds,positioning,fit,petri}
...
\include{chapter-1}   % (课外) 第1次机试练习: 熟悉DEV-C++开发平台, 基本输入输出语句练习

\include{chapter-2}   % 第2次机试练习: 选择与循环语句练习

\include{chapter-3}   % 第3次机试练习: 继续分支与循环练习

\include{chapter-4}   % 第4次机试练习: 继续分支与循环练习

\include{chapter-5}   % 第5次机试练习: 继续练习流程控制, 简单数组应用

\include{chapter-6}   % 第6次机试练习: 数组,排序,字符串练习

\include{chapter-7}   % 第7次机试练习: 函数综合练习

\include{chapter-8}   % 第8, 9次合并为综合练习

\include{chapter-9}  

\include{chapter-10}  % 试点班附加题

\include{chapter-11}  % 提交代码片段
