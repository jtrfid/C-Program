...
\include{chapter-6}   % 第6次机试练习: 流程控制, 字符串, 数组

\include{chapter-7}   % 第7次机试练习: 函数, 矩阵, 数组, 字符串, 排序

\include{chapter-8}   % 第8次机试练习: 数组,排序,字符串练习

\include{chapter-9}   % 第9次机试练习: 函数, 数组, 字符串, 结构体
