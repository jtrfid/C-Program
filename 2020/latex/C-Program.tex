...
\include{lecture-5} % ch4, 选择结构程序设计, 讲解上节课的作业(Example), 平台演示讲解if()结构

% 第7次课: 开发平台讲解循环结构, 第8次课: 讲解第2次上机练习, 第9次课: 结合第2次上机练习部分题目, 讲解函数，递归，数组, 包括ppt中的一、二维数组
...
\include{lecture-15} % ch9

\lecture{建立自己的数据类型}{part7}
\part{建立自己的数据类型}
\frame{\partpage}
\frame[shrink]{\frametitle{Outlines}\tableofcontents[hideallsubsections]} 
\include{lecture-16} %  结构体
%%%%%%%%%%%% lecture-16 期中考试总结, pow函数问题，移到第22次课讲
\include{lecture-17} % 结构体编程举例
\include{lecture-18} %  结构体编程举例续 
\end{comment}
