...
\include{lecture-4} % 数据类型, 运算符和表达式, 数学库函数，顺序程序设计举例, 平台演示讲解。布置ppt 中的Exampe页为作业
...
%\frame{\frametitle{Outlines}\tableofcontents[hideallsubsections]}
\frame[shrink]{\frametitle{Outlines}\tableofcontents} 
\include{lecture-6} % ch5, 循环结构程序设计, 第6次课
\include{lecture-7} % ch5, 循环结构程序设计举例, 第7次课
\include{lecture-8} % ch5, 循环结构程序设计举例(续), 布置作业, 学习消化ppt中的所有代码并在第2次上机时, 编写这些代码，实际调试运行。讲解第1次上机练习题
