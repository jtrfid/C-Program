...
\author{段江涛}
\title{ 计算机导论与程序设计[CS006001018,X05]}
\subtitle{机试练习参考程序代码 }
...
\include{chapter-1}   % 第1次机试练习: 熟悉DEV-C++开发平台, 基本输入输出语句练习
\include{chapter-2}   % 第2次机试练习: 选择与循环语句练习
\include{chapter-3}   % 第3次机试练习: 继续分支与循环练习
\include{chapter-4}   % 第4次机试练习: 继续练习基本输入输出语句，分支与循环，简单数组应用
\include{chapter-5}   % 第5次机试练习: 流程控制, 字符串, 数组
\include{chapter-6}   % 第6次机试练习: 函数, 矩阵, 数组, 字符串, 排序
\include{chapter-7}   % 第7次机试练习: 数组,排序,字符串练习
\include{chapter-8}   % 第8次机试练习: 函数, 数组, 字符串, 结构体
